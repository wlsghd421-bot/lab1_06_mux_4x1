...
HD_PWD='C:/Users/wlsgh/lab1_06_mux_4x1/mux_4x1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4x1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_4x1.tcl -notrace
